...
const CreatePassword = ({ navigation, route }) => {
  const { firstName, lastName, selectedCountry, phoneNumber } = route.params;
    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity
        ...
        onPress={() => {
          ...
          navigation.navigate('HowDidYouHearAboutUs', { firstName, lastName, selectedCountry, phoneNumber, password });
        }}
      >
