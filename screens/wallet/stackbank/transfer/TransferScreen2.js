...
const TransferScreen2 = ({navigation}) => {
  return (
    <View style={styles.kyc}>
      ...
      >{`What saving plan sshould the fund go to?`}</Text>
      {/* <Text style={styles.selectAMeans}>Select a means of verification</Text> */}
      <BVNContainer
        verificationMethod="Stak flex"
        propTop={214}
        propMarginLeft={248}
      ...
      />
      <BVNContainer
        verificationMethod="Target savings"
        propTop={350}
        propMarginLeft={208}
        viaBVNFontFamily="InstrumentSans-Regular"
